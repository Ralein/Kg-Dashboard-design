...
@Component({
  ...
  template: `
    <div class="flex flex-col h-full">
          ...
          <div class="group cursor-default">
            <div class="flex items-center justify-between mb-1">
              <div class="flex items-center gap-3">
                <div class="w-3 h-3 rounded-full shadow-lg" [style.background]="item.color" [style.box-shadow]="'0 0 10px ' + item.color"></div>
              ...
              <div class="flex items-center gap-3">
                ...
                <span class="text-[11px] text-[#A3AED0] font-bold">({{ item.count }} policies)</span>
              </div>
            </div>
      ...
      <div class="flex justify-between items-center pt-3 mt-2 border-t border-slate-100 shrink-0">
