        ...
        <div class="relative z-10 px-8 py-8">
          ...
          <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-2">
              <button class="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 border border-white/20 text-white text-xs font-bold hover:bg-white/20 transition-all">
                <lucide-icon [img]="Share2" class="w-3.5 h-3.5"></lucide-icon>
                Share Quote
              </button>
              <button routerLink="/quotation-management" class="p-2 bg-[#FF5252]/20 border border-[#FF5252]/40 rounded-xl text-[#FF5252] hover:bg-[#FF5252] hover:text-white transition-all">
